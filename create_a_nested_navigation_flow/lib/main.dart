...
class SelectDevicePage extends StatelessWidget {
  const SelectDevicePage({Key? key, required this.onDeviceSelected})
      : super(key: key);
...
class WaitingPage extends StatefulWidget {
  const WaitingPage(
      {Key? key, required this.message, required this.onWaitComplete})
      : super(key: key);
  ...
  Route _onGenerateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case routeDeviceSetupConnectingPage:
        page = WaitingPage(
            message: 'Connecting', onWaitComplete: _onConnectionEstablished);
        break;
